...
class Constants {
    ...
    public static final String APPLICATION_URL_FORM_ENCODED= "application/x-www-form-urlencoded";
    ...
    public static final String APP_2FA_OTP_EMAIL_TEMPLATE_RESOURCE_PATH = "templates/2fa-otp.html";
